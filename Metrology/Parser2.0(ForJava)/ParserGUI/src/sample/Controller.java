...
public class Controller {
    ...
    @FXML static TextArea textToAnalyse;@FXML ListView slocListView;@FXML ListView jilbaListView;
    ...
    @FXML public void startSlocButtonClicked() {
        ...
        String averageFunctionsStringsCount = "Average number of strings for functions: " + String.valueOf(mySlocMetric.getAverageFunctionsStringsCount());

        String functionsStringsCount = mySlocMetric.getFunctionsStringsCount().toString();
        String averageFunctionsSourceCodeStringsCount = "Average number of source code strings for functions " + String.valueOf(mySlocMetric.getAverageFunctionsSourceCodeStringsCount());

        String functionsSourceCodeStringsCount = mySlocMetric.getFunctionsSourceCodeStringsCount().toString();


        String averageClassesStringsCount = "Average number of strings for classes: " + String.valueOf(mySlocMetric.getAverageClassesStringsCount());

        String classesStringsCount = mySlocMetric.getClassesStringsCount().toString();
        String averageClassesSourceCodeStringsCount = "Average number of source code strings for classes " + String.valueOf(mySlocMetric.getAverageClassesSourceCodeStringsCount());
